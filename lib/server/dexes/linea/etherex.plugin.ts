...
// Etherex (Ramses V3 Engine)
// Universal Router: 0x85974429677c2a701af470B82F3118e74307826e
const ETHEREX_ROUTER = "0x85974429677c2a701af470B82F3118e74307826e" as const;
const RAMSES_V3_QUOTER_V2 = "0x403Bf94fe505cA0F0b1563C350B57dCeC8303ECd" as const;
...
export const EtherexPlugin: DexPlugin = {
    id: "etherex",
    name: "Etherex",
    kind: "UNISWAP_V3",
    supportedChains: [59144], // Linea
    routerAddress: ETHEREX_ROUTER,
            ...
            if (res && res.amountOut > 0n) {
                if (!bestRoute || res.amountOut > BigInt(bestRoute.amountOut)) {
                    const hop: RouteHop = {
                        ...
                        poolOrQuoter: RAMSES_V3_QUOTER_V2,
