...
export function VerifiedActivityFeed() {
    ...
    return (
        <div className={`border rounded-xl p-4 mb-6 ${error ? 'border-red-500/20 bg-red-500/5' : 'border-green-500/20 bg-green-500/5'}`}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-muted-foreground flex items-center gap-1">
                            Powered by <span className="font-bold text-green-600 dark:text-green-400">Envio HyperIndex</span>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex flex-col">
                                        ...
                                        <span className={item.success ? "text-green-500 font-medium" : "text-red-500"}>
